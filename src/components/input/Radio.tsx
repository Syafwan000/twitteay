...
const Radio = (props: RadioProps & PropsWithChildren) => {
  return (
    <div className="w-full">
      <input type="radio" name={props.name} id={props.id} value={props.id} checked={props.checked} onChange={props.onChange} readOnly={props.checked !== undefined && !props.onChange} className="peer hidden" />
